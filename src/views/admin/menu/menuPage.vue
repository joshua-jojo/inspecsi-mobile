<template lang="">
    <div
        class="h-[240px] w-full bg-primary rounded-b-[80px] text-primary-content">
        <div class="flex justify-between items-center h-[5rem] px-5 pt-16">
            ...
            <div class="avatar placeholder" v-if="!store.state.user?.foto">
    ...
    <div class="w-full h-max grid grid-cols-2 gap-4 -mt-20 px-5">
        <div
            class="card shadow-md bg-base-100 p-4"
            @click="materi"
            v-if="KepalaRuangan || KetuaTim">
            <div class="card-body h-[150px] p-4 flex flex-col">
                <img
                    src="../../../assets/icons/menu-materi.png"
                    class="h-[80%]" />
        ...
        <div
            ...
            <div class="card-body h-[150px] p-4 flex flex-col">
                <img
                    src="../../../assets/icons/menu-assessment.png"
                    class="h-[80%]" />
        ...
        <div
            class="card shadow-md bg-base-100 p-4"
            @click="archive"
            v-if="KepalaRuangan || KetuaTim || SuperAdmin">
            <div class="card-body h-[150px] p-4 flex flex-col">
                <img
                    src="../../../assets/icons/menu-archive.png"
                    class="h-[80%]" />
        ...
        <div class="card shadow-md bg-base-100 p-4" @click="profile">
            <div class="card-body h-[150px] p-4 flex flex-col">
                <img
                    src="../../../assets/icons/menu-password.svg"
                    class="h-[80%]" />
                <div class="text-center h-max -mt-2">Pengaturan</div>
            </div>
        </div>
        <div class="card shadow-md bg-base-100 p-4" @click="petunjuk">
            <div class="card-body h-[150px] p-4 flex flex-col">
                <img
                    src="../../../assets/icons/menu-petunjuk.svg"
                    class="h-[80%]" />
        ...
        <div class="card shadow-md bg-base-100 p-4" @click="tentang">
            <div class="card-body h-[150px] p-4 flex flex-col">
                <img
                    src="../../../assets/icons/menu-tentang.png"
                    class="h-[80%]" />
        ...
        <div class="card shadow-md bg-base-100 p-4" @click="logout">
            <div class="card-body h-[150px] p-4 flex flex-col">
                <img
                    src="../../../assets/icons/menu-logout.svg"
                    class="h-[80%]" />
