...
const date_set = `${tahun}-${bulan < 10 ? "0" + bulan : bulan}-${
    tanggal < 10 ? "0" + tanggal : tanggal
}`;

const data_form: any = ref({
    identitas_pasien_id: props.value.id,
    tanggal: date_set,
    implementasi: "",
    soap_subjektif: "",
    soap_objek: "",
...
<template lang="">
    <div class="flex flex-col gap-8">
        <label for="modal" class="btn btn-success" v-if="!KepalaRuangan"
    ...
    <div class="modal">
        <div class="modal-box">
            ...
            <div class="modal-action">
                <button :disabled="disabled_button" @click="add" class="btn">
                    Simpan
                </button>
