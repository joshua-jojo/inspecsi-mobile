    ...
    <div class="bg-primary h-screen absolute w-full min-h-[900px]">
        <div class="w-full h-[100%] relative">
            ...
            <div class="bg-white h-[60%] rounded-t-3xl relative">
                <div class="grid place-items-center capitalize font-poppins-bold text-primary h-[10%] text-xl">
                    ketua tim 
                </div>
                ...
                <div class="absolute bottom-0 w-full grid place-items-center h-[10%] mb-3">
                    <div v-if="disabledButton" class="w-11/12 btn btn-disabled font-poppins-bold capitalize">
                        kirim
                    </div>
                    <div @click="submitAssessment" v-else class="w-11/12 btn btn-primary font-poppins-bold capitalize">
                        kirim
                    </div>
                </div>
            </div>
