    ...
    >
      <div class="w-full">
        ...
        <div class="flex justify-center p-2">
          <img src="../../assets/logo_login.png" width="300" />
        </div>
      </div>
      <div class="w-full">
        <div class="alert alert-error w-[90%]" v-if="formLogin.message">
          <span class="capitalize text-xs">{{ formLogin.message }}</span>
        </div>
        <div class="card card-compact bg-white">
          <div class="card-body">
            <div class="form-control">
              ...
              >
                <div class="translate-y-2 text-primary">Email</div>
              </label>
              <input
                type="email"
              ...
              />
              <label v-if="formLogin.errors.email" class="label"
            ...
            <div class="form-control">
              <label
                class="ml-4 capitalize font-bold text-md bg-white w-max px-1 translate-y-1"
              >
                <div class="translate-y-2 text-primary">Password</div>
              </label>
              <input
                type="password"
              ...
              />
              <label v-if="formLogin.errors.password" class="label"
                ><span class="label-text-alt text-error">{{
